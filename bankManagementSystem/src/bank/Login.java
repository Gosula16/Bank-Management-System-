...
public class Login extends JFrame implements ActionListener {
    ...
    public Login() {
        ...
        // reason for next line: we cannot use Image for jLabel, we need to convert it
        // to ImageIcon first
                        ...
                        if (rs.next()) {
                            ...
                            if (status.equals("ACTIVE")) {
                                ...
                                int opt = JOptionPane.showConfirmDialog(null,
                                        "You have placed an account closure request," +
                                                "\nWould you like to cancel the request",
                                        "SASTRA BANK", JOptionPane.YES_NO_OPTION);
                                if (opt == YES_OPTION) {
                                    ...
                                    if (!opt1.equals("CANCEL REQUEST"))
                                        ...
                                        try {
                                            String sql1 = "UPDATE accClosure set status='USER_CANCL_REQ' , apprdate=curdate() where accNum='"
                                                    + accNum + "'";
